...
private:
    ...
    void initWindow() {
        ...
        window = glfwCreateWindow(WIDTH, HEIGHT, UC_VERSION_DISPLAY, nullptr, nullptr);
    ...
    void createInstance() {
        if (enableValidationLayers && !checkValidationLayerSupport()) {
            ...
            std::cout << "All validation layers available" << std::endl;
        }

        VkApplicationInfo appInfo{};
        appInfo.sType = VK_STRUCTURE_TYPE_APPLICATION_INFO;
        appInfo.pApplicationName = "Unicraft";
        appInfo.applicationVersion = VK_MAKE_VERSION(1, 0, 0);
        appInfo.pEngineName = "UC WEngine";
    ...
    void pickPhysicalDevice() {
        ...
        if (deviceCount == 0) {
            ...
            std::cout << "Found GPU/s with Vulkan support." << std::endl;
        }
    ...
    VkShaderModule createShaderModule(const std::vector<char>& code) {
        ...
        if (vkCreateShaderModule(device, &createInfo, nullptr, &shaderModule) != VK_SUCCESS) {
            ...
            std::cout << "Successfully created new shader module." << std::endl;
        }
    ...
    void createRenderPass(){
        ...
        if (vkCreateRenderPass(device, &renderPassInfo, nullptr, &renderPass) != VK_SUCCESS)
        {
            ...
            std::cout << "Successfuly created render pass." << std::endl;
        }
    }
    ...
    void createSyncObjects() {
        ...
        for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++)
        {
            if (vkCreateSemaphore(device, &semaphoreInfo, nullptr, &imageAvailableSemaphores[i]) != VK_SUCCESS || vkCreateSemaphore(device, &semaphoreInfo, nullptr, &renderFinishedSemaphores[i]) != VK_SUCCESS || vkCreateFence(device, &fenceInfo, nullptr, &inFlightFences[i]) != VK_SUCCESS) {
                ...
                std::cout << "Successfully created semaphores." << std::endl;
            }
        }
    ...
    static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
        auto app = reinterpret_cast<UcApp*>(glfwGetWindowUserPointer(window));
    ...
    void createTextureImage() {
        ...
        stbi_uc* pixels = stbi_load((getUCFolder() + "\\Assets\\Textures\\mk-logo.png").c_str(), &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
    ...
    void createTextureSampler() {
        ...
        samplerInfo.compareOp = VK_COMPARE_OP_ALWAYS;samplerInfo.mipmapMode = VK_SAMPLER_MIPMAP_MODE_LINEAR;
